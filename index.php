...
<div class="fb-livechat"> 
	...
	<div class="fb-widget">
	 ...
	 <div class="fb-page" data-href="https://www.facebook.com/Vinatop-Group-474977649667234/

   " data-tabs="messages" data-width="360" data-height="400" data-small-header="true" data-hide-cover="true" data-show-facepile="false">
	  </div>
	  <div id="fb-root">
	  	
	  </div>
	</div>
<a href="https://www.facebook.com/Vinatop-Group-474977649667234/
    ...
    if (isset($_GET['page'])){
        ...
        switch ($urlAnalytic) {
            ...
            case 'danh-muc-san-pham':
                ...
                include_once dirname(__FILE__).DIR_THEMES."dmsanpham.php"; break;
            case 'khuyen-mai':
...
<!-- 
<div id="share_us2">
        <iframe src="https://www.facebook.com/plugins/page.php?href=https://www.facebook.com/Vinatop-Group-474977649667234/

     

        %2F&tabs=timeline&width=340&height=212&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=220693348668109" width="340" height="212" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
    </div> -->
...
<a href="tel:02113868989" class="suntory-alo-phone suntory-alo-green" id="suntory-alo-phoneIcon" style="left: 0px; bottom: 0px;" datasqstyle="{&quot;top&quot;:null}" datasquuid="4c643075-c7e6-4adf-8841-746771cfb831" datasqtop="640">

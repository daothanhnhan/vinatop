...
////////////////////////
$tin1 = $action_news -> getNewsList_byMultiLevel_orderNewsId(1,'desc',1,4,'');
$tintuc1=$tin1['data'];
$tin2 = $action_news -> getNewsList_byMultiLevel_orderNewsId(2,'desc',1,4,'');
$tintuc2=$tin2['data'];
$tin3 = $action_news -> getNewsList_byMultiLevel_orderNewsId(3,'desc',1,4,'');
$tintuc3=$tin3['data'];
?>
  <div class="container">
  <h2 class="tit-news"><?= $lang=='vn' ? 'Tin tức' : 'News' ?></h2>
  <ul class="nav nav-tabs ">
    <li class="active canle-mb" style="margin-left: 38%;"><a href="#SP"><?= $cong_nghe['lang_newscat_name'] ?></a></li>
  ...
  <div class="tab-content">
    <div id="SP" class="tab-pane fade in active">
      ...
      <div class="col-md-3 col-xs-6 alt-hover" style="padding: 10px;">

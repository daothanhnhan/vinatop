<?php
    function set_cn () {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $name = $row['service_name'].' cn';
            $title = $row['title_seo'].' cn';
            $url = 'cn-'.$row['friendly_url'];
            $sql = "INSERT INTO service_languages (lang_service_name, title_seo, friendly_url, service_id, languages_code) VALUES ('$name', '$title', '$url', $service_id, 'cn')";

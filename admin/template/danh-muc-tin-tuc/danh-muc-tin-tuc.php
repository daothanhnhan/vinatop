<?php
    function set_cn () {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $name = $row['newscat_name'].' cn';
            $title = $row['title_seo'].' cn';
            $url = 'cn-'.$row['friendly_url'];
            $sql = "INSERT INTO newscat_languages (lang_newscat_name, title_seo, friendly_url, newscat_id, languages_code) VALUES ('$name', '$title', '$url', $newscat_id, 'cn')";

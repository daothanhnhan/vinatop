		...
		public function addProductCat(){
	    	...
	    	if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			if ($lang['languages_code'] == 'cn') {
	    				$productcat_name = 'china version ' . $productcat_name;
	    				$productcat_des = 'china version ' . $productcat_des;
	    				$productcat_content = 'china version ' . $productcat_content;
	    				$friendly_url = 'cn-' . $friendly_url;
	    			}
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			if ($lang['languages_code'] == 'cn') {
	    				$product_name = 'china version ' . $product_name;
	    				$product_des = 'china version ' . $product_des;
	    				$product_content = 'china version ' . $product_content;
	    				$friendly_url = 'cn-' . $friendly_url;
	    			}
		...
		public function addPage(){
	    	...
	    	if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			if ($lang['languages_code'] == 'cn') {
	    				$page_name = 'china version ' . $page_name;
	    				$page_des = 'china version ' . $page_des;
	    				$page_content = 'china version ' . $page_content;
	    				$friendly_url = 'cn-' . $friendly_url;
	    			}
		...
		public function addNewsCat(){
	    	...
	    	if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			if ($lang['languages_code'] == 'cn') {
	    				$newscat_name = 'china version ' . $newscat_name;
	    				$newscat_des = 'china version ' . $newscat_des;
	    				$newscat_content = 'china version ' . $newscat_content;
	    				$friendly_url = 'cn-' . $friendly_url;
	    			}
		...
		public function addNews(){
	    	...
	    	if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			if ($lang['languages_code'] == 'cn') {
	    				$news_name = 'china version ' . $news_name;
	    				$news_des = 'china version ' . $news_des;
	    				$news_content = 'china version ' . $news_content;
	    				$friendly_url = 'cn-' . $friendly_url;
	    			}
		...
		public function addServiceCat(){
	    	...
	    	if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			if ($lang['languages_code'] == 'cn') {
	    				$servicecat_name = 'china version ' . $servicecat_name;
	    				$servicecat_des = 'china version ' . $servicecat_des;
	    				$servicecat_content = 'china version ' . $servicecat_content;
	    				$friendly_url = 'cn-' . $friendly_url;
	    			}
		...
		public function addService(){
	    	...
	    	if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			if ($lang['languages_code'] == 'cn') {
	    				$service_name = 'china version ' . $service_name;
	    				$service_des = 'china version ' . $service_des;
	    				$service_content = 'china version ' . $service_content;
	    				$friendly_url = 'cn-' . $friendly_url;
	    			}

...
class action_menu extends library{
    ...
    public function showMenu_byMultiLevel_mainMenuTraiCam($list_menu,$valParent_menu = 0,$lang, $level = 0){
        ...
        if ($cate_child) {
            ...
            if ($level == 0) {
                echo '<li><img src="/images/icons/ptd_en.jpg" alt="" class="english" onclick="lang_en()"></li>';
                echo '<li><img src="/images/icons/ptd_vn.jpg" alt="" class="english" onclick="lang_vn()"></li>';
                echo '<li><img src="/images/icons/ptd_cn.png" alt="" class="english" onclick="lang_cn()"></li>';
            }
            
            echo '</ul>';        
        } 
    }
    public function showMenu_byMultiLevel_mainMenuTraiCam_sidebar($list_menu,$valParent_menu = 0,$lang, $level = 0){
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị

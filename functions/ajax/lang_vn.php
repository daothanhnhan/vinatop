<?php
	...
	switch ($urlAnalytic) {
            case 'page_language':
            	...
            	$page = $action_page->getPageLangDetail_byId($page['page_id'], 'vn');
            ...
            case 'news_languages':
            	...
            	$news = $action_news->getNewsLangDetail_byId($news['news_id'], 'vn');
            ...
            case 'servicecat_languages':
            	...
            	$service = $action_service->getServiceCatLangDetail_byId($service['servicecat_id'], 'vn');
            ...
            case 'service_languages':
                ...
                $service = $action_service->getServiceLangDetail_byId($service['service_id'], 'vn');
                echo $service['friendly_url'];
                break;
            ...
            case 'productcat_languages':
                ...
                $product = $action_product->getProductCatLangDetail_byId($product['productcat_id'], 'vn');
            ...
            case 'product_languages':
                ...
                $product = $action_product->getProductLangDetail_byId($product['product_id'], 'vn');
                echo $product['friendly_url'];
                break;
